...
CREATE TABLE `account` (
  ...
  `loginPwd` varchar(20) NOT NULL COMMENT '登陆密码',
  `createdate` datetime NOT NULL COMMENT '创建日期',
  `lastLoginDate` datetime DEFAULT NULL COMMENT '最后一次登陆时间',
  `status` smallint(6) NOT NULL DEFAULT '1' COMMENT '0=失效, 1=有效',
  `accountType` smallint(6) NOT NULL COMMENT '1=Administrator, 2=employee, 3=customer',
  `accountDesc` varchar(200) DEFAULT NULL COMMENT '用户描述',
  `custId` int(11) DEFAULT NULL COMMENT '关联客户ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='登陆用户信息表';

-- ----------------------------
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES ('1', 'a', 'a', '2014-11-08 10:51:18', '2017-07-18 23:18:30', '1', '1', null, null);
...
INSERT INTO `area` VALUES ('500224', '铜梁县', '500100');
INSERT INTO `area` VALUES ('500226', '荣昌县', '500100');
INSERT INTO `area` VALUES ('500227', '璧山县', '500100');
...
CREATE TABLE `city` (
  `ID` int(11) NOT NULL COMMENT '城市编码',
  `NAME` varchar(50) DEFAULT NULL COMMENT '城市名称',
  `PROVINCEID` int(11) NOT NULL COMMENT '所属省编码',
  PRIMARY KEY (`ID`)
...
INSERT INTO `city` VALUES ('469003', '儋州市', '460000');
...
CREATE TABLE `company` (
  ...
  `registNo` varchar(40) NOT NULL COMMENT '海关备案编号',
  `inspectionRegistNo` varchar(40) NOT NULL COMMENT '商检备案编号',
  `address` varchar(200) DEFAULT NULL COMMENT '公司地址',
  `biztype` smallint(6) DEFAULT NULL COMMENT '业务类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='公司基本信息表';

-- ----------------------------
-- Records of company
-- ----------------------------
INSERT INTO `company` VALUES ('1', 'H', '广州荟星电子商务有限公司', 'PTE51411404010000001', '1400000008', '广州市花都区', null);
INSERT INTO `company` VALUES ('2', 'R', '广州润购电子商务有限公司', '', '', '广州市花都区', null);
INSERT INTO `company` VALUES ('3', 'B', '广州荟星电子商务有限公司机场分公司', '', '', '广州市花都区', null);

-- ----------------------------
-- Table structure for `contry_code`
-- ----------------------------
DROP TABLE IF EXISTS `contry_code`;
CREATE TABLE `contry_code` (
  `COUNTRY_CODE` varchar(255) DEFAULT NULL,
  `ISO_E` varchar(255) DEFAULT NULL,
  `COUN_C_NAME` varchar(255) DEFAULT NULL,
  `COUN_E_NAME` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='国家代码表';

-- ----------------------------
-- Records of contry_code
-- ----------------------------
INSERT INTO `contry_code` VALUES ('101', 'AFG', '阿富汗', 'Afghanistan');
INSERT INTO `contry_code` VALUES ('102', 'BHR', '巴林', 'Bahrian');
INSERT INTO `contry_code` VALUES ('103', 'BGD', '孟加拉国', 'Bangladesh');
INSERT INTO `contry_code` VALUES ('104', 'BTN', '不丹', 'Bhutan');
INSERT INTO `contry_code` VALUES ('105', 'BRN', '文莱', 'Brunei');
INSERT INTO `contry_code` VALUES ('106', 'MMR', '缅甸', 'Myanmar');
INSERT INTO `contry_code` VALUES ('107', 'KHM', '柬埔寨', 'Cambodia');
INSERT INTO `contry_code` VALUES ('108', 'CYP', '塞浦路斯', 'Cyprus');
INSERT INTO `contry_code` VALUES ('109', 'PRK', '朝鲜', 'Korea,DPR');
INSERT INTO `contry_code` VALUES ('110', 'HKG', '香港', 'Hong Kong');
INSERT INTO `contry_code` VALUES ('111', 'IND', '印度', 'India');
INSERT INTO `contry_code` VALUES ('112', 'IDN', '印度尼西亚', 'Indonesia');
INSERT INTO `contry_code` VALUES ('113', 'IRN', '伊朗', 'Iran');
INSERT INTO `contry_code` VALUES ('114', 'IRQ', '伊拉克', 'Iraq');
INSERT INTO `contry_code` VALUES ('115', 'ISR', '以色列', 'Israel');
INSERT INTO `contry_code` VALUES ('116', 'JPN', '日本', 'Japan');
INSERT INTO `contry_code` VALUES ('117', 'JOR', '约旦', 'Jordan');
INSERT INTO `contry_code` VALUES ('118', 'KWT', '科威特', 'Kuwait');
INSERT INTO `contry_code` VALUES ('119', 'LAO', '老挝', 'Lao PDR');
INSERT INTO `contry_code` VALUES ('120', 'LBN', '黎巴嫩', 'Lebanon');
INSERT INTO `contry_code` VALUES ('121', 'MAC', '澳门', 'Macau');
INSERT INTO `contry_code` VALUES ('122', 'MYS', '马来西亚', 'Malaysia');
INSERT INTO `contry_code` VALUES ('123', 'MDV', '马尔代夫', 'Maldives');
INSERT INTO `contry_code` VALUES ('124', 'MNG', '蒙古', 'Mongolia');
INSERT INTO `contry_code` VALUES ('125', 'NPL', '尼泊尔联邦民主共和国', 'Nepal, FDR');
INSERT INTO `contry_code` VALUES ('126', 'OMN', '阿曼', 'Oman');
INSERT INTO `contry_code` VALUES ('127', 'PAK', '巴基斯坦', 'Pakistan');
INSERT INTO `contry_code` VALUES ('128', 'PSE', '巴勒斯坦', 'Palestine');
INSERT INTO `contry_code` VALUES ('129', 'PHL', '菲律宾', 'Philippines');
INSERT INTO `contry_code` VALUES ('130', 'QAT', '卡塔尔', 'Qatar');
INSERT INTO `contry_code` VALUES ('131', 'SAU', '沙特阿拉伯', 'Saudi Arabia');
INSERT INTO `contry_code` VALUES ('132', 'SGP', '新加坡', 'Singapore');
INSERT INTO `contry_code` VALUES ('133', 'KOR', '韩国', 'Korea, Rep.');
INSERT INTO `contry_code` VALUES ('134', 'LKA', '斯里兰卡', 'Sri Lanka');
INSERT INTO `contry_code` VALUES ('135', 'SYR', '叙利亚', 'Syrian Arab Republic');
INSERT INTO `contry_code` VALUES ('136', 'THA', '泰国', 'Thailand');
INSERT INTO `contry_code` VALUES ('137', 'TUR', '土耳其', 'Turkey');
INSERT INTO `contry_code` VALUES ('138', 'ARE', '阿联酋', 'United Arab Emirates');
INSERT INTO `contry_code` VALUES ('139', 'YEM', '也门', 'Yemen');
INSERT INTO `contry_code` VALUES ('141', 'NVM', '越南', 'Viet Nam');
INSERT INTO `contry_code` VALUES ('142', 'CHN', '中国', 'China');
INSERT INTO `contry_code` VALUES ('143', 'TWN', '台澎金马关税区', 'Taiwan, Prov.of China');
INSERT INTO `contry_code` VALUES ('144', 'TLS', '东帝汶', 'Timor-Leste');
INSERT INTO `contry_code` VALUES ('145', 'KAZ', '哈萨克斯坦', 'Kazakhstan');
INSERT INTO `contry_code` VALUES ('146', 'KGZ', '吉尔吉斯斯坦', 'Kyrgyzstan');
INSERT INTO `contry_code` VALUES ('147', 'TJK', '塔吉克斯坦', 'Tajikistan');
INSERT INTO `contry_code` VALUES ('148', 'TKM', '土库曼斯坦', 'Turkmenistan');
INSERT INTO `contry_code` VALUES ('149', 'UZB', '乌兹别克斯坦', 'Uzbekistan');
INSERT INTO `contry_code` VALUES ('199', '', '亚洲其他国家(地区)', 'Oth. Asia nes');
INSERT INTO `contry_code` VALUES ('201', 'DZA', '阿尔及利亚', 'Algeria');
INSERT INTO `contry_code` VALUES ('202', 'AGO', '安哥拉', 'Angola');
INSERT INTO `contry_code` VALUES ('203', 'BEN', '贝宁', 'Benin');
INSERT INTO `contry_code` VALUES ('204', 'BWA', '博茨瓦纳', 'Botswana');
INSERT INTO `contry_code` VALUES ('205', 'BDI', '布隆迪', 'Burundi');
INSERT INTO `contry_code` VALUES ('206', 'CMR', '喀麦隆', 'Cameroon');
INSERT INTO `contry_code` VALUES ('207', '', '加那利群岛', 'Canary Islands');
INSERT INTO `contry_code` VALUES ('208', 'CPV', '佛得角', 'Cape Verde');
INSERT INTO `contry_code` VALUES ('209', 'CAF', '中非', 'Central African Republic.');
INSERT INTO `contry_code` VALUES ('210', '', '塞卜泰(休达)', 'Ceuta');
INSERT INTO `contry_code` VALUES ('211', 'TCD', '乍得', 'Chad');
INSERT INTO `contry_code` VALUES ('212', 'COM', '科摩罗', 'Comoros');
INSERT INTO `contry_code` VALUES ('213', 'COG', '刚果(布)', 'Congo');
INSERT INTO `contry_code` VALUES ('214', 'DJI', '吉布提', 'Djibouti');
INSERT INTO `contry_code` VALUES ('215', 'EGY', '埃及', 'Egypt');
INSERT INTO `contry_code` VALUES ('216', 'GNQ', '赤道几内亚', 'Equatorial Guinea');
INSERT INTO `contry_code` VALUES ('217', 'ETH', '埃塞俄比亚', 'Ethiopia');
INSERT INTO `contry_code` VALUES ('218', 'GAB', '加蓬', 'Gabon');
INSERT INTO `contry_code` VALUES ('219', 'GMB', '冈比亚', 'Gambia');
INSERT INTO `contry_code` VALUES ('220', 'GHA', '加纳', 'Ghana');
INSERT INTO `contry_code` VALUES ('221', 'GIN', '几内亚', 'Guinea');
INSERT INTO `contry_code` VALUES ('222', 'GNB', '几内亚比绍', 'Guinea-Bissau');
INSERT INTO `contry_code` VALUES ('223', 'CIV', '科特迪瓦', 'Cote d\'lvoire');
INSERT INTO `contry_code` VALUES ('224', 'KEN', '肯尼亚', 'Kenya');
INSERT INTO `contry_code` VALUES ('225', 'LBR', '利比里亚', 'Liberia');
INSERT INTO `contry_code` VALUES ('226', 'LBY', '利比亚', 'Libyan Arab Jamahiriya');
INSERT INTO `contry_code` VALUES ('227', 'MDG', '马达加斯加', 'Madagascar');
INSERT INTO `contry_code` VALUES ('228', 'MWI', '马拉维', 'Malawi');
INSERT INTO `contry_code` VALUES ('229', 'MLI', '马里', 'Mali');
INSERT INTO `contry_code` VALUES ('230', 'MRT', '毛里塔尼亚', 'Mauritania');
INSERT INTO `contry_code` VALUES ('231', 'MUS', '毛里求斯', 'Mauritius');
INSERT INTO `contry_code` VALUES ('232', 'MAR', '摩洛哥', 'Morocco');
INSERT INTO `contry_code` VALUES ('233', 'MOZ', '莫桑比克', 'Mozambique');
INSERT INTO `contry_code` VALUES ('234', 'NAM', '纳米比亚', 'Namibia');
INSERT INTO `contry_code` VALUES ('235', 'NER', '尼日尔', 'Niger');
INSERT INTO `contry_code` VALUES ('236', 'NGA', '尼日利亚', 'Nigeria');
INSERT INTO `contry_code` VALUES ('237', 'REU', '留尼汪', 'Reunion');
INSERT INTO `contry_code` VALUES ('238', 'RWA', '卢旺达', 'Rwanda');
INSERT INTO `contry_code` VALUES ('239', 'STP', '圣多美和普林西比', 'Sao Tome and Principe');
INSERT INTO `contry_code` VALUES ('240', 'SEN', '塞内加尔', 'Senegal');
INSERT INTO `contry_code` VALUES ('241', 'SYC', '塞舌尔', 'Seychelles');
INSERT INTO `contry_code` VALUES ('242', 'SLE', '塞拉利昂', 'Sierra Leone');
INSERT INTO `contry_code` VALUES ('243', 'SOM', '索马里', 'Somalia');
INSERT INTO `contry_code` VALUES ('244', 'ZAF', '南非', 'South Africa');
INSERT INTO `contry_code` VALUES ('245', 'ESH', '西撒哈拉', 'Western Sahara');
INSERT INTO `contry_code` VALUES ('246', 'SDN', '苏丹', 'Sudan');
INSERT INTO `contry_code` VALUES ('247', 'TZA', '坦桑尼亚', 'Tanzania');
INSERT INTO `contry_code` VALUES ('248', 'TGO', '多哥', 'Togo');
INSERT INTO `contry_code` VALUES ('249', 'TUN', '突尼斯', 'Tunisia');
INSERT INTO `contry_code` VALUES ('250', 'UGA', '乌干达', 'Uganda');
INSERT INTO `contry_code` VALUES ('251', 'BFA', '布基纳法索', 'Burkina Faso');
INSERT INTO `contry_code` VALUES ('252', 'COD', '刚果(金)', 'Congo,DR');
INSERT INTO `contry_code` VALUES ('253', 'ZMB', '赞比亚', 'Zambia');
INSERT INTO `contry_code` VALUES ('254', 'ZWE', '津巴布韦', 'Zimbabwe');
INSERT INTO `contry_code` VALUES ('255', 'LSO', '莱索托', 'Lesotho');
INSERT INTO `contry_code` VALUES ('256', '', '梅利利亚', 'Melilla');
INSERT INTO `contry_code` VALUES ('257', 'SWZ', '斯威士兰', 'Swaziland');
INSERT INTO `contry_code` VALUES ('258', 'ERI', '厄立特里亚', 'Eritrea');
INSERT INTO `contry_code` VALUES ('259', 'MYT', '马约特', 'Mayotte');
INSERT INTO `contry_code` VALUES ('260', 'NULL', '南苏丹共和国', 'Republic of South Sudan ');
INSERT INTO `contry_code` VALUES ('299', '', '非洲其他国家(地区)', 'Oth. Afr. nes');
INSERT INTO `contry_code` VALUES ('301', 'BEL', '比利时', 'Belgium');
INSERT INTO `contry_code` VALUES ('302', 'DNK', '丹麦', 'Denmark');
INSERT INTO `contry_code` VALUES ('303', 'GBR', '英国', 'United Kingdom');
INSERT INTO `contry_code` VALUES ('304', 'DEU', '德国', 'Germany');
INSERT INTO `contry_code` VALUES ('305', 'FRA', '法国', 'France');
INSERT INTO `contry_code` VALUES ('306', 'IRL', '爱尔兰', 'Ireland');
INSERT INTO `contry_code` VALUES ('307', 'ITA', '意大利', 'Italy');
INSERT INTO `contry_code` VALUES ('308', 'LUX', '卢森堡', 'Luxembourg');
INSERT INTO `contry_code` VALUES ('309', 'NLD', '荷兰', 'Netherlands');
INSERT INTO `contry_code` VALUES ('310', 'GRC', '希腊', 'Greece');
INSERT INTO `contry_code` VALUES ('311', 'PRT', '葡萄牙', 'Portugal');
INSERT INTO `contry_code` VALUES ('312', 'ESP', '西班牙', 'Spain');
INSERT INTO `contry_code` VALUES ('313', 'ALB', '阿尔巴尼亚', 'Albania');
INSERT INTO `contry_code` VALUES ('314', 'AND', '安道尔', 'Andorra');
INSERT INTO `contry_code` VALUES ('315', 'AUT', '奥地利', 'Austria');
INSERT INTO `contry_code` VALUES ('316', 'BGR', '保加利亚', 'Bulgaria');
INSERT INTO `contry_code` VALUES ('318', 'FIN', '芬兰', 'Finland');
INSERT INTO `contry_code` VALUES ('320', 'GIB', '直布罗陀', 'Gibraltar');
INSERT INTO `contry_code` VALUES ('321', 'HUN', '匈牙利', 'Hungary');
INSERT INTO `contry_code` VALUES ('322', 'ISL', '冰岛', 'Iceland');
INSERT INTO `contry_code` VALUES ('323', 'LIE', '列支敦士登', 'Liechtenstein');
INSERT INTO `contry_code` VALUES ('324', 'MLT', '马耳他', 'Malta');
INSERT INTO `contry_code` VALUES ('325', 'MCO', '摩纳哥', 'Monaco');
INSERT INTO `contry_code` VALUES ('326', 'NOR', '挪威', 'Norway');
INSERT INTO `contry_code` VALUES ('327', 'POL', '波兰', 'Poland');
INSERT INTO `contry_code` VALUES ('328', 'ROM', '罗马尼亚', 'Romania');
INSERT INTO `contry_code` VALUES ('329', 'SMR', '圣马力诺', 'San Marino');
INSERT INTO `contry_code` VALUES ('330', 'SWE', '瑞典', 'Sweden');
INSERT INTO `contry_code` VALUES ('331', 'CHE', '瑞士', 'Switzerland');
INSERT INTO `contry_code` VALUES ('334', 'EST', '爱沙尼亚', 'Estonia');
INSERT INTO `contry_code` VALUES ('335', 'LVA', '拉脱维亚', 'Latvia');
INSERT INTO `contry_code` VALUES ('336', 'LTU', '立陶宛', 'Lithuania');
INSERT INTO `contry_code` VALUES ('337', 'GEO', '格鲁吉亚', 'Georgia');
INSERT INTO `contry_code` VALUES ('338', 'ARM', '亚美尼亚', 'Armenia');
INSERT INTO `contry_code` VALUES ('339', 'AZE', '阿塞拜疆', 'Azerbai jan');
INSERT INTO `contry_code` VALUES ('340', 'BLR', '白俄罗斯', 'Belarus');
INSERT INTO `contry_code` VALUES ('343', 'MDA', '摩尔多瓦', 'Moldova');
INSERT INTO `contry_code` VALUES ('344', 'RUS', '俄罗斯联邦', 'Russian Federation');
INSERT INTO `contry_code` VALUES ('347', 'UKR', '乌克兰', 'Ukraine');
INSERT INTO `contry_code` VALUES ('349', 'NULL', '塞尔维亚和黑山', '');
INSERT INTO `contry_code` VALUES ('350', 'SVN', '斯洛文尼亚', 'Slovenia ');
INSERT INTO `contry_code` VALUES ('351', 'HRV', '克罗地亚', 'Croatia');
INSERT INTO `contry_code` VALUES ('352', 'CZE', '捷克', 'Czech Republic');
INSERT INTO `contry_code` VALUES ('353', 'SVK', '斯洛伐克', 'Slovakia');
INSERT INTO `contry_code` VALUES ('354', 'MKD', '前南马其顿', 'Macedonia,FYR');
INSERT INTO `contry_code` VALUES ('355', 'BIH', '波黑', 'Bosnia and Hercegovina');
INSERT INTO `contry_code` VALUES ('356', 'VAT', '梵蒂冈城国', 'Vatican City State');
INSERT INTO `contry_code` VALUES ('357', 'FRO', '法罗群岛', 'Faroe Islands');
INSERT INTO `contry_code` VALUES ('358', 'SRB', '塞尔维亚', 'Serbia');
INSERT INTO `contry_code` VALUES ('359', 'MNE', '黑山', 'Montenegro');
INSERT INTO `contry_code` VALUES ('399', '', '欧洲其他国家(地区)', 'Oth. Eur. nes');
INSERT INTO `contry_code` VALUES ('401', 'ATG', '安提瓜和巴布达', 'Antigua & Barbuda');
INSERT INTO `contry_code` VALUES ('402', 'ARG', '阿根廷', 'Argentina');
INSERT INTO `contry_code` VALUES ('403', 'ABW', '阿鲁巴', 'Aruba');
INSERT INTO `contry_code` VALUES ('404', 'BHS', '巴哈马', 'Bahamas');
INSERT INTO `contry_code` VALUES ('405', 'BRB', '巴巴多斯', 'Barbados');
INSERT INTO `contry_code` VALUES ('406', 'BLZ', '伯利兹', 'Belize');
INSERT INTO `contry_code` VALUES ('408', 'BOL', '多民族玻利维亚国', 'Estado Plurinacional de Bolivia');
INSERT INTO `contry_code` VALUES ('409', '', '博内尔', 'Bonaire');
INSERT INTO `contry_code` VALUES ('410', 'BRA', '巴西', 'Brazil');
INSERT INTO `contry_code` VALUES ('411', 'CYM', '开曼群岛', 'Cayman Islands');
INSERT INTO `contry_code` VALUES ('412', 'CHL', '智利', 'Chile');
INSERT INTO `contry_code` VALUES ('413', 'COL', '哥伦比亚', 'Colombia');
INSERT INTO `contry_code` VALUES ('414', 'DMA', '多米尼克', 'Dominica');
INSERT INTO `contry_code` VALUES ('415', 'CRI', '哥斯达黎加', 'Costa Rica');
INSERT INTO `contry_code` VALUES ('416', 'CUB', '古巴', 'Cuba');
INSERT INTO `contry_code` VALUES ('417', '', '库腊索岛', 'Curacao');
INSERT INTO `contry_code` VALUES ('418', 'DOM', '多米尼加共和国', 'Dominican Republic');
INSERT INTO `contry_code` VALUES ('419', 'ECU', '厄瓜多尔', 'Ecuador');
INSERT INTO `contry_code` VALUES ('420', 'GUF', '法属圭亚那', 'French Guiana');
INSERT INTO `contry_code` VALUES ('421', 'GRD', '格林纳达', 'Grenada');
INSERT INTO `contry_code` VALUES ('422', 'GLP', '瓜德罗普', 'Guadeloupe');
INSERT INTO `contry_code` VALUES ('423', 'GTM', '危地马拉', 'Guatemala');
INSERT INTO `contry_code` VALUES ('424', 'GUY', '圭亚那', 'Guyana');
INSERT INTO `contry_code` VALUES ('425', 'HTI', '海地', 'Haiti');
INSERT INTO `contry_code` VALUES ('426', 'HND', '洪都拉斯', 'Honduras');
INSERT INTO `contry_code` VALUES ('427', 'JAM', '牙买加', 'Jamaica');
INSERT INTO `contry_code` VALUES ('428', 'MTQ', '马提尼克', 'Martinique');
INSERT INTO `contry_code` VALUES ('429', 'MEX', '墨西哥', 'Mexico');
INSERT INTO `contry_code` VALUES ('430', 'MSR', '蒙特塞拉特', 'Montserrat');
INSERT INTO `contry_code` VALUES ('431', 'NIC', '尼加拉瓜', 'Nicaragua');
INSERT INTO `contry_code` VALUES ('432', 'PAN', '巴拿马', 'Panama');
INSERT INTO `contry_code` VALUES ('433', 'PRY', '巴拉圭', 'Paraguay');
INSERT INTO `contry_code` VALUES ('434', 'PER', '秘鲁', 'Peru');
INSERT INTO `contry_code` VALUES ('435', 'PRI', '波多黎各', 'Puerto Rico');
INSERT INTO `contry_code` VALUES ('436', '', '萨巴', 'Saba');
INSERT INTO `contry_code` VALUES ('437', 'LCA', '圣卢西亚', 'Saint Lucia');
INSERT INTO `contry_code` VALUES ('438', '', '圣马丁岛', 'Saint Martin Islands');
INSERT INTO `contry_code` VALUES ('439', 'VCT', '圣文森特和格林纳丁斯', 'Saint Vincent and Grenadines');
INSERT INTO `contry_code` VALUES ('440', 'SLV', '萨尔瓦多', 'El Salvador');
INSERT INTO `contry_code` VALUES ('441', 'SUR', '苏里南', 'Suriname');
INSERT INTO `contry_code` VALUES ('442', 'TTO', '特立尼达和多巴哥', 'Trinidad and Tobago');
INSERT INTO `contry_code` VALUES ('443', 'TCA', '特克斯和凯科斯群岛', 'Turks and Caicos Islands');
INSERT INTO `contry_code` VALUES ('444', 'URY', '乌拉圭', 'Uruguay');
INSERT INTO `contry_code` VALUES ('445', 'VEN', '委内瑞拉', 'Venezuela');
INSERT INTO `contry_code` VALUES ('446', 'VGB', '英属维尔京群岛', 'Virgin  Islands, British');
INSERT INTO `contry_code` VALUES ('447', 'KNA', '圣其茨和尼维斯', 'Saint  Kitts and Nevis');
INSERT INTO `contry_code` VALUES ('448', 'SPM', '圣皮埃尔和密克隆', 'Saint.Pierre and Miquelon');
INSERT INTO `contry_code` VALUES ('449', 'ANT', '荷属安地列斯', 'Netherlands Antilles');
INSERT INTO `contry_code` VALUES ('499', '', '拉丁美洲其他国家(地区)', 'Oth. L.Amer. nes');
INSERT INTO `contry_code` VALUES ('501', 'CAN', '加拿大', 'Canada');
INSERT INTO `contry_code` VALUES ('502', 'USA', '美国', 'United States');
INSERT INTO `contry_code` VALUES ('503', 'GRL', '格陵兰', 'Greenland');
INSERT INTO `contry_code` VALUES ('504', 'BMU', '百慕大', 'Bermuda');
INSERT INTO `contry_code` VALUES ('599', '', '北美洲其他国家(地区)', 'Oth. N.Amer. nes');
INSERT INTO `contry_code` VALUES ('601', 'AUS', '澳大利亚', 'Australia');
INSERT INTO `contry_code` VALUES ('602', 'COK', '库克群岛', 'Cook Islands');
INSERT INTO `contry_code` VALUES ('603', 'FJI', '斐济', 'Fiji');
INSERT INTO `contry_code` VALUES ('604', '', '盖比群岛', 'Gambier Islands');
INSERT INTO `contry_code` VALUES ('605', '', '马克萨斯群岛', 'Marquesas Islands');
INSERT INTO `contry_code` VALUES ('606', 'NRU', '瑙鲁', 'Nauru');
INSERT INTO `contry_code` VALUES ('607', 'NCL', '新喀里多尼亚', 'New Caledonia');
INSERT INTO `contry_code` VALUES ('608', 'VUT', '瓦努阿图', 'Vanuatu');
INSERT INTO `contry_code` VALUES ('609', 'NZL', '新西兰', 'New Zealand');
INSERT INTO `contry_code` VALUES ('610', 'NFK', '诺福克岛', 'Norfolk Island');
INSERT INTO `contry_code` VALUES ('611', 'PNG', '巴布亚新几内亚', 'Papua New Guinea');
INSERT INTO `contry_code` VALUES ('612', '', '社会群岛', 'Society Islands');
INSERT INTO `contry_code` VALUES ('613', 'SLB', '所罗门群岛', 'Solomon Islands');
INSERT INTO `contry_code` VALUES ('614', 'TON', '汤加', 'Tonga');
INSERT INTO `contry_code` VALUES ('615', '', '土阿莫土群岛', 'Tuamotu Islands');
INSERT INTO `contry_code` VALUES ('616', '', '土布艾群岛', 'Tubai Islands');
INSERT INTO `contry_code` VALUES ('617', 'WSM', '萨摩亚', 'Samoa');
INSERT INTO `contry_code` VALUES ('618', 'KIR', '基里巴斯', 'Kiribati');
INSERT INTO `contry_code` VALUES ('619', 'TUV', '图瓦卢', 'Tuvalu');
INSERT INTO `contry_code` VALUES ('620', 'FSM', '密克罗尼西亚联邦', 'Micronesia, Fs');
INSERT INTO `contry_code` VALUES ('621', 'MHL', '马绍尔群岛', 'Marshall Islands');
INSERT INTO `contry_code` VALUES ('622', 'PLW', '帕劳', 'Palau');
INSERT INTO `contry_code` VALUES ('623', 'PYF', '法属波利尼西亚', 'French Polynesia');
INSERT INTO `contry_code` VALUES ('625', 'WLF', '瓦利斯和浮图纳', 'Wallis and Futuna');
INSERT INTO `contry_code` VALUES ('699', '', '大洋洲其他国家(地区)', 'Oth. Ocean. nes');
INSERT INTO `contry_code` VALUES ('701', '', '国(地)别不详', 'Countries(reg.) unknown');
INSERT INTO `contry_code` VALUES ('702', '', '联合国及机构和国际组织', 'UN and oth. int\'l  org.');
INSERT INTO `contry_code` VALUES ('999', '', '中性包装原产国别', 'Conutries of Neutral Package');

-- ----------------------------
-- Table structure for `curr_code`
-- ----------------------------
DROP TABLE IF EXISTS `curr_code`;
CREATE TABLE `curr_code` (
  `CURR_CODE` varchar(255) DEFAULT NULL,
  `CURR_SYMB` varchar(255) DEFAULT NULL,
  `ISO_CURR` varchar(255) DEFAULT NULL,
  `CURR_NAME` varchar(255) DEFAULT NULL,
  KEY `index_curr_code` (`CURR_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='国家货币表';

-- ----------------------------
-- Records of curr_code
-- ----------------------------
INSERT INTO `curr_code` VALUES ('110', 'HKD   ', 'NULL', '港币');
INSERT INTO `curr_code` VALUES ('112', 'IDR', 'NULL', '印度尼西亚卢比');
INSERT INTO `curr_code` VALUES ('116', 'JPY   ', 'NULL', '日本元');
INSERT INTO `curr_code` VALUES ('121', 'MOP   ', 'NULL', '澳门元');
INSERT INTO `curr_code` VALUES ('122', 'MYR', 'NULL', '马来西亚林吉特');
INSERT INTO `curr_code` VALUES ('129', 'PHP   ', 'NULL', '菲律宾比索');
INSERT INTO `curr_code` VALUES ('132', 'SGD   ', 'NULL', '新加坡元');
INSERT INTO `curr_code` VALUES ('133', 'KRW', 'NULL', '韩国圆');
INSERT INTO `curr_code` VALUES ('136', 'THB   ', 'NULL', '泰国铢');
INSERT INTO `curr_code` VALUES ('142', 'CNY   ', 'NULL', '人民币');
INSERT INTO `curr_code` VALUES ('143', 'TWD', 'NULL', '新台币');
INSERT INTO `curr_code` VALUES ('300', 'EUR  ', 'NULL', '欧元');
INSERT INTO `curr_code` VALUES ('302', 'DKK   ', 'NULL', '丹麦克朗');
INSERT INTO `curr_code` VALUES ('303', 'GBP   ', 'NULL', '英镑');
INSERT INTO `curr_code` VALUES ('326', 'NOK   ', 'NULL', '挪威克朗');
INSERT INTO `curr_code` VALUES ('330', 'SEK   ', 'NULL', '瑞典克朗');
INSERT INTO `curr_code` VALUES ('331', 'CHF   ', 'NULL', '瑞士法郎');
INSERT INTO `curr_code` VALUES ('344', 'RUB', 'NULL', '俄罗斯卢布');
INSERT INTO `curr_code` VALUES ('501', 'CAD   ', 'NULL', '加拿大元');
INSERT INTO `curr_code` VALUES ('502', 'USD   ', 'NULL', '美元');
INSERT INTO `curr_code` VALUES ('601', 'AUD   ', 'NULL', '澳大利亚元');
...
CREATE TABLE `ewaybill` (
  ...
  `EntRecordName` varchar(255) DEFAULT NULL COMMENT '物流企业代码',
  `EntRecordNo` varchar(30) DEFAULT NULL COMMENT '物流企业名称',
  `WayBillNo` varchar(30) NOT NULL COMMENT '企业运单编号',
  `DeclareType` varchar(1) NOT NULL DEFAULT '1' COMMENT '申报类型 1-新增，3--删除;',
  `LogisticsStatus` varchar(100) NOT NULL DEFAULT '发货' COMMENT '物流状态',
  `Freight` decimal(19,5) NOT NULL DEFAULT '0.00000' COMMENT '运费',
  `ValuationFee` decimal(19,5) NOT NULL DEFAULT '0.00000' COMMENT '保价费',
  `NoticeNo` varchar(255) DEFAULT NULL COMMENT '物流公司',
  `Note` varchar(255) DEFAULT NULL COMMENT '备注',
  `Tax` decimal(19,5) DEFAULT '0.00000' COMMENT '税款',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='运单基本信息表';

-- ----------------------------
-- Records of ewaybill
-- ----------------------------
INSERT INTO `ewaybill` VALUES ('1', 'H00377180001', null, null, '3828960142702', '1', '发货', '10.00000', '50.00000', '顺丰', null, '1.00000');
INSERT INTO `ewaybill` VALUES ('2', 'H00377190001', null, null, '1108811088', '1', '发货', '10.00000', '10.00000', '顺丰', null, '1.00000');

-- ----------------------------
-- Table structure for `gmuser`
-- ----------------------------
DROP TABLE IF EXISTS `gmuser`;
CREATE TABLE `gmuser` (
  `instKey` int(11) NOT NULL AUTO_INCREMENT,
  `gmUserName` varchar(45) DEFAULT NULL COMMENT '客户名称',
  `coName` varchar(100) DEFAULT NULL COMMENT '电商平台',
  `contactor` varchar(100) DEFAULT NULL COMMENT '联系人',
  `userStatus` smallint(6) DEFAULT NULL COMMENT '客户状态',
  `phoneNo` varchar(100) DEFAULT NULL COMMENT '联系电话',
  `DESC` varchar(200) DEFAULT NULL COMMENT '客户描述',
  PRIMARY KEY (`instKey`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='客户基本信息表';

-- ----------------------------
-- Records of gmuser
-- ----------------------------
INSERT INTO `gmuser` VALUES ('1', 'a', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('2', 'licheng', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('3', 'hubing', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('4', 'xulin123', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('5', 'zhaochunbo', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('6', 'wuzhongbo', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('7', 'wangfujie', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('8', 'puffhouse', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('9', 'mamibaohe', '天猫', 'licheng', '1', '15111111111', 'abc');
INSERT INTO `gmuser` VALUES ('10', 'yuanbei', '天猫', 'licheng', '1', '15111111111', 'abc');

-- ----------------------------
-- Table structure for `gmuser_bk`
-- ----------------------------
DROP TABLE IF EXISTS `gmuser_bk`;
CREATE TABLE `gmuser_bk` (
  `instKey` int(11) NOT NULL AUTO_INCREMENT,
  `gmUserName` varchar(45) DEFAULT NULL,
  `gmUserPWD` varchar(45) DEFAULT NULL,
...
-- ----------------------------
-- Records of gmuser_bk
-- ----------------------------
INSERT INTO `gmuser_bk` VALUES ('1', 'a', 'a', null, '1', '1', '2014-10-21 00:00:00', null);
...
CREATE TABLE `goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '企业内部编号',
  `CopGNo` varchar(30) DEFAULT NULL COMMENT '货号',
  `SellID` varchar(30) DEFAULT NULL COMMENT '在销售网站上商品的ID',
  `goodsENName` varchar(200) DEFAULT NULL COMMENT '商品英文名称',
  `GName` varchar(200) DEFAULT NULL COMMENT '商品中文名称',
  `Manufactory` varchar(200) DEFAULT NULL COMMENT '生产厂家',
  `country` varchar(200) DEFAULT NULL COMMENT '原产地',
  `HSCode` varchar(10) DEFAULT NULL COMMENT 'HS Code',
  `curr` varchar(3) DEFAULT NULL COMMENT '币制',
  `RMB` varchar(10) DEFAULT NULL COMMENT '币制RMB',
  `DecPrice` decimal(18,5) DEFAULT NULL COMMENT '申报价格',
  `NetWt` decimal(19,5) DEFAULT NULL COMMENT '净重(公斤)',
  `GrossWt` decimal(19,5) DEFAULT NULL COMMENT '毛重(公斤)',
  `pingming` varchar(100) DEFAULT NULL COMMENT '品名',
  `Brand` varchar(100) DEFAULT NULL COMMENT '品牌',
  `yongtu` varchar(200) DEFAULT NULL COMMENT '用途',
  `GModel` varchar(100) DEFAULT NULL COMMENT '包装/型号',
  `chengfen` varchar(100) DEFAULT NULL COMMENT '成份含量',
  `NetworkSellName` varchar(200) DEFAULT NULL COMMENT '网站销售渠道',
  `HyperLink` varchar(300) DEFAULT NULL COMMENT '网站链接',
  `batchId` varchar(30) DEFAULT NULL COMMENT '批次号',
  `unit` varchar(50) DEFAULT NULL COMMENT '计量单位',
  `PostTariffCode` varchar(12) DEFAULT NULL COMMENT '行邮税号',
  `PostTariffName` varchar(255) DEFAULT NULL COMMENT '行邮税名',
  `EportGoodsNo` varchar(30) DEFAULT NULL COMMENT '电商平台商品备案申请号',
  `registNo` varchar(30) DEFAULT NULL COMMENT '海关备案号',
  `appDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '申请时间',
  `appEndDate` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '申请完成时间',
  `createUserId` int(11) DEFAULT NULL,
  `lastupdateuserid` int(11) DEFAULT NULL,
  `lastUpdateTime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '最后修改时间',
  `gdesc` varchar(200) DEFAULT NULL COMMENT '商品描述',
  `sellRmb` decimal(18,5) DEFAULT NULL,
  `ciqgoodsno` varchar(30) DEFAULT NULL COMMENT '商检备案号',
  `active` smallint(6) DEFAULT '1' COMMENT '商品有效状态 1:有效 2:失效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='商品基本信息表';

-- ----------------------------
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('1', 'LaT001', '39537275681', 'La Tourangelle Roasted Walnut Oil 500ml', 'La Tourangelle 核桃油 500ml', 'La Tourangelle Inc.', '502', '1212', '502', '99', '9.00000', '0.59000', '0.91000', '核桃油', 'La Tourangelle', '营养补充', '罐装 500ml', '核桃油', '天猫国际', 'http://www.tmall.com', '001', '122', '11212', '食品', null, 'Dennis0080001', '2017-07-18 23:41:42', '2017-07-17 09:33:33', '3', null, '2017-07-17 09:33:33', null, null, 'Dennis0080001', '1');
INSERT INTO `goods` VALUES ('2', 'DHA-60*2', '39503991248', 'life\'sDHA™ All-Vegetarian DHA Supplement 200mg DHA 60 Softgels', 'life\'sDHA™ 全素食胶囊DHA补充剂200mg60粒装', 'Martek Biosciences Corporation', '502', '1212', '502', '168', '19.00000', '0.06000', '0.14000', 'DHA补充剂', 'life\'sDHA™', '营养补充', '瓶装 60粒', '海藻油', '天猫国际', 'http://www.tmall.com', '1212', '142', '1212', '保健品', null, 'Dennis0080002', '2017-07-18 23:41:43', '2017-07-17 09:53:14', '3', null, '2017-07-17 09:53:14', null, null, 'Dennis0080002', '1');
INSERT INTO `goods` VALUES ('3', 'C-L-T08', '41155968710', 'Child Life Pure DHA Soft Gel Capsules, 90-Count', '童年时光DHA胶囊，90颗', 'childlife', '502', '121212', '502', '108', '6.00000', '0.07000', '0.15000', '营养胶囊', 'child life', '营养补充', '瓶装 90颗', '营养液', '天猫国际', 'http://www.tmall.com', '122', '142', '121212', '营养品', null, 'Dennis0080003', '2017-07-18 23:41:43', '2017-07-17 10:24:46', '3', null, '2017-07-17 10:24:46', null, null, 'Dennis0080003', '1');
INSERT INTO `goods` VALUES ('4', 'HB00107', '40174515038', 'Happy Bellies Organic Baby Cereals with DHA Plus Pre and Probiotics,198g*2', '禧贝有机益生菌DHA米粉198g*2', 'childlife', '502', '121212', '502', '83', '7.50000', '0.39600', '0.70000', '米粉组合', 'child life', '营养补充', '瓶装 90颗', '营养液', 'http://www.tmall.com', 'http://detail.tmall.hk/hk/item.htm?spm=0.0.0.0.qRQfKJ&id=41331355944', '1212', '122', '1212', '辅食', null, 'Dennis0080004', '2017-07-18 23:41:44', '2017-07-17 10:33:02', '3', null, '2017-07-17 10:33:02', null, null, 'Dennis0080004', '1');
INSERT INTO `goods` VALUES ('5', 'MK-001', '39651547258', 'munchkin; 3 bowls with suction bases /mighty grip suction bowldining set', '美国Munchkin麦肯奇/吸盘碗、婴儿训练碗/餐具套装碗勺', 'Munchkin', '502', '11212', '502', '65', '6.80000', '0.45300', '0.70000', '餐具', 'munchkin', '辅食碗', '套装', 'PP材质', '天猫国际', 'http://detail.tmall.hk/hk/item.htm?spm=a1z10.3.w4011-', '12', '011', '121212', '器具', null, 'Dennis0090001', '2017-07-18 23:41:45', '2017-07-17 11:35:41', '3', null, '2017-07-17 11:35:41', null, null, 'Dennis0090001', '1');
...
CREATE TABLE `idcard` (
  ...
  `cardNo` varchar(20) NOT NULL COMMENT '身份证号码',
  `createdate` datetime NOT NULL COMMENT '创建日期',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for `int_entrepot`
-- ----------------------------
DROP TABLE IF EXISTS `int_entrepot`;
CREATE TABLE `int_entrepot` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '入库ID自增',
  `no` varchar(20) NOT NULL COMMENT '入库编号',
  `writedate` timestamp NULL DEFAULT '0000-00-00 00:00:00' COMMENT '录入日期',
  `remark` varchar(200) DEFAULT NULL COMMENT '备注',
  `companyid` int(11) DEFAULT NULL COMMENT '公司ID（下拉）',
  `batchno` varchar(30) DEFAULT NULL COMMENT '批次号系统生成年月日时分秒',
  `custid` int(11) DEFAULT NULL COMMENT '客户id',
  `createuserid` int(11) DEFAULT NULL,
  `transinstkey` char(25) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='入库基本信息表';

-- ----------------------------
-- Records of int_entrepot
-- ----------------------------
INSERT INTO `int_entrepot` VALUES ('1', 'R0030001', '2017-07-18 23:27:13', '', '1', '7718', '3', '1', null);
INSERT INTO `int_entrepot` VALUES ('2', 'R0030002', '2017-07-18 23:29:21', '', '1', '7718', '3', '1', null);
INSERT INTO `int_entrepot` VALUES ('5', 'R0030003', '2017-07-19 00:44:02', '', '1', '7719', '3', '1', null);

-- ----------------------------
-- Table structure for `int_entrepot_detail`
-- ----------------------------
DROP TABLE IF EXISTS `int_entrepot_detail`;
CREATE TABLE `int_entrepot_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `entrepotid` int(11) DEFAULT NULL COMMENT '入库id',
  `goodsid` int(11) DEFAULT NULL COMMENT '商品ID',
  `DecPrice` decimal(19,5) NOT NULL COMMENT '商品单价',
  `GQty` int(11) NOT NULL COMMENT '商品数量',
  `DeclTotal` decimal(19,5) NOT NULL COMMENT '商品总价',
  `barCode` varchar(40) DEFAULT NULL COMMENT '条形码',
  `seqNo` int(11) DEFAULT NULL COMMENT '用户流水号',
  `Note` varchar(30) DEFAULT NULL COMMENT '备注',
  `actNo` int(11) DEFAULT NULL COMMENT '实际入库数量',
  `CurrentInventory` int(11) NOT NULL DEFAULT '0' COMMENT '剩余数量',
  `batchno` varchar(10) DEFAULT NULL COMMENT '批次号,入库完成后才生成',
  `lastupdate` datetime DEFAULT NULL COMMENT '入库时间',
  `createuserid` int(11) DEFAULT NULL COMMENT '入库操作员',
  `incomeuserid` int(11) DEFAULT NULL COMMENT '入库操作人员ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='入库详细信息表';

-- ----------------------------
-- Records of int_entrepot_detail
-- ----------------------------
INSERT INTO `int_entrepot_detail` VALUES ('1', '1', '1', '99.00000', '200', '9900.00000', '0080001 7718', null, '', '100', '199', '7718', '2017-07-18 23:43:15', null, '1');
INSERT INTO `int_entrepot_detail` VALUES ('2', '2', '3', '108.00000', '200', '10800.00000', '0080003 7718', null, '', '100', '100', '7718', '2017-07-18 23:43:42', null, '1');
INSERT INTO `int_entrepot_detail` VALUES ('3', '5', '5', '65.00000', '100', '6500.00000', '0090001 7719', null, '', '100', '100', '7719', '2017-07-19 00:44:18', null, '1');

-- ----------------------------
-- Table structure for `loading_goods`
-- ----------------------------
DROP TABLE IF EXISTS `loading_goods`;
CREATE TABLE `loading_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '装载商品信息表',
  `orderId` varchar(30) DEFAULT NULL COMMENT '订单id',
  `loadingId` int(11) DEFAULT NULL COMMENT '装载表id',
  `ListEntNo` varchar(30) DEFAULT NULL COMMENT '清单企业内部编号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='装载商品信息表';

-- ----------------------------
-- Records of loading_goods
-- ----------------------------
INSERT INTO `loading_goods` VALUES ('1', 'H00377180001', '1', null);
INSERT INTO `loading_goods` VALUES ('2', 'H00377190001', '2', null);

-- ----------------------------
-- Table structure for `loading_info`
-- ----------------------------
DROP TABLE IF EXISTS `loading_info`;
CREATE TABLE `loading_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '装载ID',
  `EntInsideNo` varchar(30) DEFAULT NULL COMMENT '企业内部编号',
  `MasterCustoms` varchar(4) DEFAULT NULL COMMENT '申报地海关',
  `VeName` varchar(32) DEFAULT NULL COMMENT '车牌号',
  `LoadingDate` date DEFAULT NULL COMMENT '装载日期',
  `Note` varchar(255) DEFAULT NULL COMMENT '备注',
  `InputDate` date DEFAULT NULL COMMENT '录入日期',
  `GrossWt` decimal(19,5) DEFAULT NULL COMMENT '总重量',
  `loading_no` varchar(30) DEFAULT NULL COMMENT '装载单号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='装载信息表';

-- ----------------------------
-- Records of loading_info
-- ----------------------------
INSERT INTO `loading_info` VALUES ('1', null, null, '粤B2312', '2017-07-18', null, '2017-07-18', null, '201707182356412563');
INSERT INTO `loading_info` VALUES ('2', null, null, '粤B2222', '2017-07-19', null, '2017-07-19', null, '201707190049127305');

-- ----------------------------
-- Table structure for `order_flow_num`
-- ----------------------------
DROP TABLE IF EXISTS `order_flow_num`;
CREATE TABLE `order_flow_num` (
...
CREATE TABLE `order_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `OrderId` varchar(30) NOT NULL DEFAULT '' COMMENT '订单编号：D+客户编码+四位日期+3位流水号',
...
-- ----------------------------
INSERT INTO `order_goods` VALUES ('1', 'H00377180001', '1', '99.00000', '2', '198.00000', '');
INSERT INTO `order_goods` VALUES ('2', 'H00377190001', '1', '99.00000', '1', '99.00000', '');
...
CREATE TABLE `order_info` (
  ...
  `OrderId` varchar(30) NOT NULL DEFAULT '' COMMENT '订单编号：D+客户编码+四位日期+3位流水号',
  `EntRecordNo` varchar(40) DEFAULT NULL COMMENT '电子订单编号',
  `EntRecordName` int(11) DEFAULT NULL COMMENT '客户',
  `OrderName` varchar(30) NOT NULL COMMENT '收件人姓名',
  `OrderDocId` varchar(30) DEFAULT NULL COMMENT '收件人证件号',
  `OrderAddress` varchar(255) DEFAULT NULL COMMENT '收件人地址',
  `OrderPhone` varchar(50) DEFAULT NULL COMMENT '联系电话',
  `OrderDate` datetime NOT NULL COMMENT '录入日期',
  `OrderStatus` varchar(1) NOT NULL DEFAULT 'S' COMMENT '订单状态 S-订单新增，C-订单取消',
  `OrderGoodTotal` decimal(19,5) NOT NULL DEFAULT '0.00000' COMMENT '订单总额',
  `Freight` decimal(19,5) NOT NULL DEFAULT '0.00000' COMMENT '运费',
  `Tax` decimal(19,5) NOT NULL DEFAULT '0.00000' COMMENT '税款',
  `OrderGoodTotalCurr` varchar(3) NOT NULL COMMENT '订单币制',
  `Note` varchar(255) DEFAULT NULL COMMENT '备注',
  `Createruserid` int(11) DEFAULT NULL COMMENT '创建人ID',
  `Ewaysnum` varchar(40) DEFAULT NULL COMMENT '运单号',
  `status` varchar(2) DEFAULT '0' COMMENT '订单处理状态：0.清关中 1.放行 2.出库 3.发货（默认清关中）',
  `OrderDocType` varchar(3) DEFAULT NULL COMMENT '证件类型',
  `province` int(11) DEFAULT NULL COMMENT '省',
  `city` int(11) DEFAULT NULL COMMENT '市',
  `area` int(11) DEFAULT NULL COMMENT '县',
  `loading_no` varchar(30) DEFAULT NULL COMMENT '装载单号',
  `releasedDate` datetime DEFAULT NULL COMMENT '订单放行日期',
  `pickgoodsno` varchar(32) DEFAULT NULL COMMENT '拣货单号',
  `firstCreateName` varchar(120) DEFAULT NULL COMMENT '初始创建人名称',
  PRIMARY KEY (`OrderId`)
...
-- ----------------------------
INSERT INTO `order_info` VALUES ('1', 'H00377180001', '12345', '3', '李成', '411722197202132411', '建材城西路金燕龙办公楼一层', '18618144424', '2017-07-18 23:45:36', 'S', '0.00000', '0.00000', '0.00000', '142', '', '1', '3828960142702', '3', null, '110000', '110100', '110101', '201707182356412563', '2017-07-18 23:53:30', '20170718234612792', 'a');
INSERT INTO `order_info` VALUES ('1', 'H00377190001', '45678', '3', '范冰冰', '512501197203035172', '珠吉路58号津安创意园', '13222222222', '2017-07-19 00:46:58', 'S', '0.00000', '0.00000', '0.00000', '142', '', '1', '1108811088', '3', null, '120000', '120100', '120102', '201707190049127305', '2017-07-19 00:48:18', '20170719004752782', 'a');
...
CREATE TABLE `province` (
  `ID` int(11) NOT NULL COMMENT '省编码',
  `NAME` varchar(50) DEFAULT NULL COMMENT '省名称',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='省编码表';
...
-- ----------------------------
INSERT INTO `tb_sequence` VALUES ('3', '2', '1', '2017-07-19');

-- ----------------------------
-- Table structure for `ui_import_goods`
-- ----------------------------
DROP TABLE IF EXISTS `ui_import_goods`;
CREATE TABLE `ui_import_goods` (
  `gname` varchar(200) DEFAULT NULL,
  `gmodel` varchar(200) DEFAULT NULL,
  `CopGNo` varchar(100) DEFAULT NULL,
  `userkey` int(11) DEFAULT NULL,
  `transinstkey` char(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ui_import_goods
-- ----------------------------

-- ----------------------------
-- Table structure for `ui_import_int_entrepot`
-- ----------------------------
DROP TABLE IF EXISTS `ui_import_int_entrepot`;
CREATE TABLE `ui_import_int_entrepot` (
  `transinstkey` char(25) NOT NULL COMMENT '每次导入的唯一标识,对应int_entrepot里的transinstkey',
  `usergoodscode` char(7) NOT NULL COMMENT '客户商品编码',
  `numCount` int(11) NOT NULL DEFAULT '0' COMMENT '商品数量',
  `note` varchar(200) DEFAULT NULL COMMENT '备注信息'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='入库导入UI表';

-- ----------------------------
-- Records of ui_import_int_entrepot
-- ----------------------------

-- ----------------------------
-- Table structure for `ui_order`
-- ----------------------------
DROP TABLE IF EXISTS `ui_order`;
CREATE TABLE `ui_order` (
  `ORDERID` varchar(30) NOT NULL COMMENT '订单ID',
  `TRANSINSTKEY` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='装载表';
...
-- ----------------------------
-- Table structure for `unit_code`
-- ----------------------------
DROP TABLE IF EXISTS `unit_code`;
CREATE TABLE `unit_code` (
  `UNIT_CODE` varchar(255) NOT NULL,
  `UNIT_name` varchar(255) NOT NULL,
  KEY `index_unit_code` (`UNIT_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='计量单位表';

-- ----------------------------
-- Records of unit_code
-- ----------------------------
INSERT INTO `unit_code` VALUES ('001', '台');
INSERT INTO `unit_code` VALUES ('002', '座');
INSERT INTO `unit_code` VALUES ('003', '辆');
INSERT INTO `unit_code` VALUES ('004', '艘');
INSERT INTO `unit_code` VALUES ('005', '架');
INSERT INTO `unit_code` VALUES ('006', '套');
INSERT INTO `unit_code` VALUES ('007', '个');
INSERT INTO `unit_code` VALUES ('008', '只');
INSERT INTO `unit_code` VALUES ('009', '头');
INSERT INTO `unit_code` VALUES ('010', '张');
INSERT INTO `unit_code` VALUES ('011', '件');
INSERT INTO `unit_code` VALUES ('012', '支');
INSERT INTO `unit_code` VALUES ('013', '枝');
INSERT INTO `unit_code` VALUES ('014', '根');
INSERT INTO `unit_code` VALUES ('015', '条');
INSERT INTO `unit_code` VALUES ('016', '把');
INSERT INTO `unit_code` VALUES ('017', '块');
INSERT INTO `unit_code` VALUES ('018', '卷');
INSERT INTO `unit_code` VALUES ('019', '副');
INSERT INTO `unit_code` VALUES ('020', '片');
INSERT INTO `unit_code` VALUES ('021', '组');
INSERT INTO `unit_code` VALUES ('022', '份');
INSERT INTO `unit_code` VALUES ('023', '幅');
INSERT INTO `unit_code` VALUES ('025', '双');
INSERT INTO `unit_code` VALUES ('026', '对');
INSERT INTO `unit_code` VALUES ('027', '棵');
INSERT INTO `unit_code` VALUES ('028', '株');
INSERT INTO `unit_code` VALUES ('029', '井');
INSERT INTO `unit_code` VALUES ('030', '米');
INSERT INTO `unit_code` VALUES ('031', '盘');
INSERT INTO `unit_code` VALUES ('032', '平方米');
INSERT INTO `unit_code` VALUES ('033', '立方米');
INSERT INTO `unit_code` VALUES ('034', '筒');
INSERT INTO `unit_code` VALUES ('035', '千克');
INSERT INTO `unit_code` VALUES ('036', '克');
INSERT INTO `unit_code` VALUES ('037', '盆');
INSERT INTO `unit_code` VALUES ('038', '万个');
INSERT INTO `unit_code` VALUES ('039', '具');
INSERT INTO `unit_code` VALUES ('040', '百副');
INSERT INTO `unit_code` VALUES ('041', '百支');
INSERT INTO `unit_code` VALUES ('042', '百把');
INSERT INTO `unit_code` VALUES ('043', '百个');
INSERT INTO `unit_code` VALUES ('044', '百片');
INSERT INTO `unit_code` VALUES ('045', '刀');
INSERT INTO `unit_code` VALUES ('046', '疋');
INSERT INTO `unit_code` VALUES ('047', '公担');
INSERT INTO `unit_code` VALUES ('048', '扇');
INSERT INTO `unit_code` VALUES ('049', '百枝');
INSERT INTO `unit_code` VALUES ('050', '千只');
INSERT INTO `unit_code` VALUES ('051', '千块');
INSERT INTO `unit_code` VALUES ('052', '千盒');
INSERT INTO `unit_code` VALUES ('053', '千枝');
INSERT INTO `unit_code` VALUES ('054', '千个');
INSERT INTO `unit_code` VALUES ('055', '亿支');
INSERT INTO `unit_code` VALUES ('056', '亿个');
INSERT INTO `unit_code` VALUES ('057', '万套');
INSERT INTO `unit_code` VALUES ('058', '千张');
INSERT INTO `unit_code` VALUES ('059', '万张');
INSERT INTO `unit_code` VALUES ('060', '千伏安');
INSERT INTO `unit_code` VALUES ('061', '千瓦');
INSERT INTO `unit_code` VALUES ('062', '千瓦时');
INSERT INTO `unit_code` VALUES ('063', '千升');
INSERT INTO `unit_code` VALUES ('067', '英尺');
INSERT INTO `unit_code` VALUES ('070', '吨');
INSERT INTO `unit_code` VALUES ('071', '长吨');
INSERT INTO `unit_code` VALUES ('072', '短吨');
INSERT INTO `unit_code` VALUES ('073', '司马担');
INSERT INTO `unit_code` VALUES ('074', '司马斤');
INSERT INTO `unit_code` VALUES ('075', '斤');
INSERT INTO `unit_code` VALUES ('076', '磅');
INSERT INTO `unit_code` VALUES ('077', '担');
INSERT INTO `unit_code` VALUES ('078', '英担');
INSERT INTO `unit_code` VALUES ('079', '短担');
INSERT INTO `unit_code` VALUES ('080', '两');
INSERT INTO `unit_code` VALUES ('081', '市担');
INSERT INTO `unit_code` VALUES ('083', '盎司');
INSERT INTO `unit_code` VALUES ('084', '克拉');
INSERT INTO `unit_code` VALUES ('085', '市尺');
INSERT INTO `unit_code` VALUES ('086', '码');
INSERT INTO `unit_code` VALUES ('088', '英寸');
INSERT INTO `unit_code` VALUES ('089', '寸');
INSERT INTO `unit_code` VALUES ('095', '升');
INSERT INTO `unit_code` VALUES ('096', '毫升');
INSERT INTO `unit_code` VALUES ('097', '英加仑');
INSERT INTO `unit_code` VALUES ('098', '美加仑');
INSERT INTO `unit_code` VALUES ('099', '立方英尺');
INSERT INTO `unit_code` VALUES ('101', '立方尺');
INSERT INTO `unit_code` VALUES ('110', '平方码');
INSERT INTO `unit_code` VALUES ('111', '平方英尺');
INSERT INTO `unit_code` VALUES ('112', '平方尺');
INSERT INTO `unit_code` VALUES ('115', '英制马力');
INSERT INTO `unit_code` VALUES ('116', '公制马力');
INSERT INTO `unit_code` VALUES ('118', '令');
INSERT INTO `unit_code` VALUES ('120', '箱');
INSERT INTO `unit_code` VALUES ('121', '批');
INSERT INTO `unit_code` VALUES ('122', '罐');
INSERT INTO `unit_code` VALUES ('123', '桶');
INSERT INTO `unit_code` VALUES ('124', '扎');
INSERT INTO `unit_code` VALUES ('125', '包');
INSERT INTO `unit_code` VALUES ('126', '箩');
INSERT INTO `unit_code` VALUES ('127', '打');
INSERT INTO `unit_code` VALUES ('128', '筐');
INSERT INTO `unit_code` VALUES ('129', '罗');
INSERT INTO `unit_code` VALUES ('130', '匹');
INSERT INTO `unit_code` VALUES ('131', '册');
INSERT INTO `unit_code` VALUES ('132', '本');
INSERT INTO `unit_code` VALUES ('133', '发');
INSERT INTO `unit_code` VALUES ('134', '枚');
INSERT INTO `unit_code` VALUES ('135', '捆');
INSERT INTO `unit_code` VALUES ('136', '袋');
INSERT INTO `unit_code` VALUES ('139', '粒');
INSERT INTO `unit_code` VALUES ('140', '盒');
INSERT INTO `unit_code` VALUES ('141', '合');
INSERT INTO `unit_code` VALUES ('142', '瓶');
INSERT INTO `unit_code` VALUES ('143', '千支');
INSERT INTO `unit_code` VALUES ('144', '万双');
INSERT INTO `unit_code` VALUES ('145', '万粒');
INSERT INTO `unit_code` VALUES ('146', '千粒');
INSERT INTO `unit_code` VALUES ('147', '千米');
INSERT INTO `unit_code` VALUES ('148', '千英尺');
INSERT INTO `unit_code` VALUES ('149', '百万贝可');
INSERT INTO `unit_code` VALUES ('163', '部');
INSERT INTO `unit_code` VALUES ('164', '亿株');
...
CREATE TABLE `usergoods` (
  `INSTKEY` char(7) NOT NULL,
  `USERKEY` int(11) NOT NULL,
  `GOODSID` int(11) NOT NULL,
  `ACTIVE` smallint(6) NOT NULL DEFAULT '1',
  `totalNo` int(11) DEFAULT '0' COMMENT '总库存数量',
  PRIMARY KEY (`INSTKEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户商品关系表';

-- ----------------------------
-- Records of usergoods
-- ----------------------------
INSERT INTO `usergoods` VALUES ('0080001', '3', '1', '1', '997');
INSERT INTO `usergoods` VALUES ('0080002', '3', '2', '1', '1000');
INSERT INTO `usergoods` VALUES ('0080003', '3', '3', '1', '1000');
INSERT INTO `usergoods` VALUES ('0080004', '3', '4', '1', '1000');
INSERT INTO `usergoods` VALUES ('0090001', '3', '5', '1', '1100');
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `_nextval`(n int) RETURNS int(11)
begin  
declare _cur Integer;
declare extflg integer;
set _cur=(select current_value from tb_sequence where USERID= n and lastupdate=Date(now())); 
if _cur is null then 
    set extflg=0;    
    set extflg=(select count(userid) from tb_sequence where userid=n);    
    if extflg = 0 then
        insert into tb_sequence(userid,current_value,_increment,lastupdate) values(n,1,1,Date(now()));
    end if;
    set _cur=1;
end if;
update tb_sequence
 set current_value = _cur + _increment,lastupdate=Date(now())
 where USERID=n ;
return _cur;  
end
;;
