        ...
        success:function(data){
            ...
            try{
                ...
                if (data.success == false){
                    ...
                    $.messager.alert("提示信息","订单导入成功",'info',function(){
...
function checkBeforeSubmit(){
    ...
    if(fileName == ''){
        $.messager.alert("提示信息", "请选择要导订单excel文件!","info");
        return false;
    }
    var ext = fileName.substring(fileName.lastIndexOf('.') + 1);
    if(ext.toUpperCase() != 'XLS'){
        $.messager.alert("提示信息","Only excel 2003 file is supported!","info");
        return false;
    }
    return true;
}
	...
	<form id="import" action="${pageContext.request.contextPath}/order/import" enctype="multipart/form-data" method="post" style="margin:0px;padding:0px">
	   <div style="height:40px">
	       <font color="red">*</font>&nbsp;请选择公司:
		   <select id="importCompany" name="importCompany" style="width:156px" class="easyui-combobox">
		      <option value=""></option>
        ...
        <div style="height:40px">
           ...
           <select id="importUser" name="importUser"  class="easyui-combobox" style="width:156px">
            <option value=""></option>
          ...
          <div style="height:40px">
          <font color="red">*</font>&nbsp;订单 币制:&nbsp;
        <select name="importcurr" id="importcurr" style="width:156px">
    					<option value="142"  >人民币</option>
    				</select>
    	</div>		
   		<font color="red">*</font>&nbsp;请选择需要导入的订单文件:<br/>
