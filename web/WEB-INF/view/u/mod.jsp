    ...
    <form id="ff" method="post">
    	<table cellpadding="0">
    		<tr>
    			...
    			<td width="156">${gmUser.gmusername }</td>
    			<td>&nbsp;<input type="hidden" id="hiddenInstkey" value="${gmUser.instkey }"></input></td>
    		</tr>
    		<tr>
    			<td><font color="red">*</font>&nbsp;当前密码:</td>
    			<td><input type="password" id="p" name="gmuserpwd" maxlength="20"></input></td>
    			<td>支持英文和数字，长度为6-20</td>
    		</tr>
    		<tr>
    			<td><font color="red">*</font>&nbsp;新密码:</td>
    			<td><input type="password" id="p1" name="gmuserpwd" maxlength="20"></input></td>
    			<td>支持英文和数字，长度为6-20</td>
    		</tr>
    		<tr>
    			<td><font color="red">*</font>&nbsp;确认新密码:</td>
    			<td><input type="password" id="p2" name="gmuserpwd" maxlength="20"></input></td>
    			<td>支持英文和数字，长度为6-20</td>
    		</tr>
    	</table>
    </form>
...
<script>
	function submitForm(){
		...
		var param = {};
		param.oldPWD = $('#p').val();
		param.gmuserpwd = $('#p1').val();
		$.ajax({
			url: '${appName}/u/modSave',
			type: 'POST',
			dataType: 'json',
